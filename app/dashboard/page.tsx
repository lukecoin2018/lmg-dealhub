      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="premium-card p-5 hover:scale-105 transition-transform duration-200">
            ...
            <p className="text-3xl font-bold text-[var(--color-text-primary)] mb-1">0</p>
        ...
        {/* Quick Actions */}
        <div>
          <h2 className="text-xl font-bold text-[var(--color-text-primary)] mb-4" style={{fontFamily: 'var(--font-playfair, "Playfair Display", Georgia, serif)'}}>Quick Actions</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link href="/calculator" className="premium-card p-6 hover:scale-105 transition-all duration-200 group block">
              ...
              <h3 className="text-lg font-extrabold text-[var(--color-text-primary)] mb-2">Calculate Rate</h3>
            ...
            <Link href="/negotiate" className="premium-card p-6 hover:scale-105 transition-all duration-200 group block">
              ...
              <h3 className="text-lg font-extrabold text-[var(--color-text-primary)] mb-2">Negotiate Deal</h3>
            ...
            <Link href="/contracts/generate" className="premium-card p-6 hover:scale-105 transition-all duration-200 group block">
              ...
              <h3 className="text-lg font-extrabold text-[var(--color-text-primary)] mb-2">Generate Contract</h3>
            ...
            <Link href="/deals" className="premium-card p-6 hover:scale-105 transition-all duration-200 group block">
              ...
              <h3 className="text-lg font-extrabold text-[var(--color-text-primary)] mb-2">New Deal</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="premium-card p-6">
            <h2 className="text-xl font-bold text-[var(--color-text-primary)] mb-6" style={{fontFamily: 'var(--font-playfair, "Playfair Display", Georgia, serif)'}}>Upcoming Deadlines</h2>
          ...
          <div className="premium-card p-6">
            <h2 className="text-xl font-bold text-[var(--color-text-primary)] mb-6" style={{fontFamily: 'var(--font-playfair, "Playfair Display", Georgia, serif)'}}>Recent Deals</h2>
            <div className="text-center py-12">
